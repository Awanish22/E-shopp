...
<h2>User:>>><span  class="blink">{{Session::get('user')['name']}}</span></h2>
<div class="row">
    <div class="col-75">
        <div class="container">
            <form id="validate" action="" method="post">
                ...
                <div class="row">
                    <div class="col-50">
                        ...
                        <input type="text" id="fname" name="name" placeholder="Max" required>
                        <label for="email"><i class="fa fa-envelope"></i> Email</label>
                        <input type="text" id="email" name="email" placeholder="max@gmail.com" required>
                        <label for="adr"><i class="fa fa-address-card-o"></i> Address</label>
                        <input type="text" id="adr" name="address" placeholder="Gorakhpur india" required>
                        <label for="city"><i class="fa fa-institution"></i> City</label>
                        <input type="text" id="city" name="city" placeholder="Gorakhpur" required>

                        <div class="row">
                            <div class="col-50">
                                <label for="state">State</label>
                                <input type="text" id="state" name="state" placeholder="Uttar Pradesh"required>
                            </div>
                            <div class="col-50">
                                <label for="zip">Zip</label>
                                <input type="text" id="zip" name="zip" placeholder="273213"required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-50">
                        ...
                        <input type="text" id="cname" name="cardname" placeholder="max"required>
 ...
 -->                <input type="submit" value="Continue to checkout" class="btn">
           ...
           <a href="/"> <input type="submit" value="Go Back" class="btn"></a>
        </div>
    </div>
    <div class="col-25">
        <div class="container">
