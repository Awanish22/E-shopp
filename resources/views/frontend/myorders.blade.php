            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <h1 class="page-header text-center margin-bottom-0">Orders</h1>
                    </div>
                    <form action="/cart">
                                    ...
                                    <li>
                                        ...
                                        {{-- <div class="col-md-3 col-sm-3 col-xs-12 margin-top-20 text-right cart-center-xs">
                                            <div class="full-width">
                                                ...
                                                <a href="/removecart/" class="btn btn-default display-inline-b paira-cart-page-delete  margin-bottom-10"><i class="fa fa-times"></i> Remove</a>
                                            </div>
                                        </div> --}}
                                    </li>
